...
#define MSG_NOIMPL(_s_)				(g_xim_message_error(G_XIM_PROTOCOL_GET_IFACE (proto)->message, "No implementation or an error occurred in %s", #_s_))
#define MSG_NOIMPL_IM(_s_,_imid_)		(g_xim_message_error(G_XIM_PROTOCOL_GET_IFACE (proto)->message, "No implementation or an error occurred in %s [imid: %d]", #_s_, (_imid_)))
#define MSG_NOIMPL_IMIC(_s_,_imid_,_icid_)	(g_xim_message_error(G_XIM_PROTOCOL_GET_IFACE (proto)->message, "No implementation or an error occurred in %s [imid: %d, icid: %d]", #_s_, (_imid_), (_icid_)))
					...
					guint16        icid)
{
	...
	g_xim_message_bug(iface->message, "No real implementation of `%s' or any errors occurred.", func);
					  ...
					  const gchar   *error_message)
{
	...
	if (flag & G_XIM_EMASK_VALID_ICID)
		...
		sicid = g_strdup("");
	g_xim_message_error(G_XIM_PROTOCOL_GET_IFACE (proto)->message,
